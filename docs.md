...
## Versioning
- `VERSION.txt` holds the current version string (`1.6.1`).
...
- Show Hops now displays plain prefix values (`Prefix: AB` / `Prefix: ABCD` / `Prefix: ABCDEF`) and aligns the displayed prefix with rendered route direction.
