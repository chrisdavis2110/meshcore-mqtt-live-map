...
- `CARTO_BASEMAP_KEY` enables CARTO Dark Matter and satellite label tiles. The key is intentionally exposed in browser tile requests and should be domain-restricted. Without it, the dark-map control is disabled and satellite imagery loads without the CARTO label overlay.
