...
## v1.9.6 (08-18-2026)
- Fixed issue #96 by adding `CARTO_BASEMAP_KEY` support for CARTO Dark Matter, satellite labels, and dark social preview images. Deployments without a key no longer request watermarked CARTO tiles: the dark-map control is hidden, previews fall back to OpenStreetMap, and satellite imagery remains available without the CARTO label overlay.
