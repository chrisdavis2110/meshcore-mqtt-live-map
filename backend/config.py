...
ROUTE_HISTORY_HIDE_MOVED_DEVICES = os.getenv(
  "ROUTE_HISTORY_HIDE_MOVED_DEVICES", "false"
).strip().lower() == "true"
ROUTE_HISTORY_MOVED_DEVICE_DISTANCE_KM = float(
  os.getenv("ROUTE_HISTORY_MOVED_DEVICE_DISTANCE_KM", "5")
)
